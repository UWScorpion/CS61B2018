...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        /**One particularly vexing issue is that the argument passed
         * to the equals method is of type Object, not of type SimpleOomage,
         * so you will need to do a cast. However, doing a cast without
         * verifying that the Object is a SimpleOomage wont’ work,
         * because you don’t want your code to crash if someone calls
         * .equals with an argument that is not a SimpleOomage.
         * Thus, we’ll need to use a new method of the Object class called getClass.
         * */
