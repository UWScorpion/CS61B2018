...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
        ...
        /**fill in the testHashCodePerfect of TestSimpleOomage
         * with code that tests to see if the hashCode function is perfect.
        ...
        for (int i = 0; i< 100; i++) {
            SimpleOomage other = SimpleOomage.randomSimpleOomage();
