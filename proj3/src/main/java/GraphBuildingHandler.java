...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> possible_nodes = new ArrayList<>();
    private GraphDB.Node n;
    private GraphDB.Edge e;
...
//            System.out.println("Beginning a way...");
            ...
            possible_nodes.add(Long.parseLong(attributes.getValue("ref")));
            ...
            if (k.equals("maxspeed")) {
                ...
                e.extraInfo.put("maxspeed", v);
            } else if (k.equals("highway")) {
                //System.out.println("Highway type: " + v);
                /* TODO Figure out whether this way and its connections are valid. */
                /* Hint: Setting a "flag" is good enough! */
                e.extraInfo.put("highway", v);
            } else if (k.equals("name")) {
                //System.out.println("Way Name: " + v);
                e.extraInfo.put("name", v);
            }
...
//           System.out.println("Node's name: " + attributes.getValue("v"));
            n.extraInfo.put("name", attributes.getValue("v"));
        }
    }
...
//            System.out.println("Finishing a way...");
            if (e.extraInfo.containsKey("highway")
                    && ALLOWED_HIGHWAY_TYPES.contains(e.extraInfo.get("highway"))){
                g.connect(possible_nodes);
            }
            possible_nodes = new ArrayList<>();
        }
    }
